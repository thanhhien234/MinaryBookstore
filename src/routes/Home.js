...
function Home() {
    ...
    return (
        <div className="main-container">
            ...
            />
            <InterestSection bookList={bookList} />
            <CreateBtn />
        </div>
    );
}

function BookListSection({ categoryShow, setCategoryShow, buttonArr, bookList }) {
    return (
...
function BestSellersSection({ bestSellersCategories, activeCategory, setActiveCategory }) {
    return (
        <div className="best-sellers-container">
            ...
            <div className="best-sellers-category-wrapper">
                {bestSellersCategories.map((name, index) => (
                    <button 
                        key={index} 
                        className={`best-sellers-btn ${activeCategory === name ? 'active' : ''}`} 
...
function InterestSection({ bookList }) {
    return (
